...
const SignIn: React.FC = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // @ts-ignore
      const response = await fetch(`${import.meta.env.VITE_API_URL}/auth/customer/google/login`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="flex min-h-screen justify-center items-center bg-gradient-to-r from-gray-100 to-gray-200 font-nunito">
      <div className="w-full max-w-md p-4 space-y-4 bg-white rounded-l-2xl shadow-lg">
      <form ref={ref} className="mt-4 space-y-4" onSubmit={handleSubmit}>
